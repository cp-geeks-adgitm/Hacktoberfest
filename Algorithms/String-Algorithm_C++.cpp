...
int main()
{
	/*Disclaimer: It is not necessary to pass 1 and 2 on following Methods.
	You can pass whatever string you might like*/
	//Will even works if you seperate follwing methods from class into functions. 
	int strcount;
	char copy[20];
	char concat[20];
	char reverse[20];
	String name("David","Thapa");
	
	//1 is considered first string passed to constructor
	...
	//2 is considered second string passed to constructor
